    ...
    <div class="am-signin-wrapper">
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>Online Marriage Registration</h2>
              <p>This method allows couples to submit their marriage details, required documents, and other relevant information through a designated online portal provided by government or authorized agencies. </p>
